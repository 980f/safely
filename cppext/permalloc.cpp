...
void *permAlloc(unsigned quantity,unsigned sizeofone){
  ...
  int aligner = permanentlyAllocated % sizeofone;//need to roundup to next multiple of given thing, some items need to be aligned in memory or we get an UNALIGNED
                                                 // fault.
  if(aligner) {
