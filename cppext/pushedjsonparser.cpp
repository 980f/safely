...
JsonStats::DepthTracker::DepthTracker(JsonStats &s) : CountedLock( s.nested){  // increments nested , when this tracker is deleted CountedLock deletion will decrement nested.
