...
#include "glibmm/ustring.h"  //unicode string used by our text editor
...
public:
  ...
  static gunichar charFor(const Glib::ustring &hiraganaFragment, int &);
  ...
  static Glib::ustring candidates(const Glib::ustring &name,CJK nameset);
