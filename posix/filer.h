...
public:
   ...
   * @param maxalloc is just 'unsigned' as we only want this to work with small files. For larger ones use memory mapping to implement this functionality.
   */
  bool readall(unsigned maxalloc=BadLength);//default arg: effectively unlimited
